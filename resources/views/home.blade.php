    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="main-dashboard-header-right">
            ...
            <div>
                ...
                <p style="margin-bottom: 0;">نوع المستخدم : 
                    @foreach (Auth::user()->getRoleNames() as $v)
                        <label class=" badge badge-success">{{ $v }}</label>
                    @endforeach
                </p>
                    <p style="margin-bottom: 0;">حالة المستخدم : <label class=" badge badge-success">{{ Auth::user()->status }}</label></p>
                @endif
                

                {{-- <p>User Role: {{ Auth::user()->roles_name}}</p> --}}
                                ...
                                <span class="text-white op-7">
                                    ...
                                    @php
                                        ...
                                        if ($count_invoices2 == 0) {
                                            ...
                                            echo $count_invoices2 = number_format(($count_invoices2 / $count_all) * 100) . '%';
                                        }
                                    @endphp
