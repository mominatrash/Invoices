    ...
    <div class="container-fluid">
        <div class="main-header-left ">
            ...
            <div class="main-header-center mr-3 d-sm-none d-md-none d-lg-block">
                <input class="form-control" placeholder="إبحث من هنا.." type="search"> <button class="btn"><i
                        ...
                        <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
                            ...
                            <a href="#" class="dropdown-item d-flex">
                                <span class="avatar  ml-3 align-self-center bg-transparent"><img
                                        ...
                                        alt="img"></span>
                                <div class="d-flex">
                                    <span class="mt-2">الالمانية</span>
                                </div>
                            </a>
                            <a href="#" class="dropdown-item d-flex">
                                <span class="avatar ml-3 align-self-center bg-transparent"><img
                                        ...
                                        alt="img"></span>
                                <div class="d-flex">
                                    <span class="mt-2">الايطالية</span>
                                </div>
                            </a>
                            <a href="#" class="dropdown-item d-flex">
                                <span class="avatar ml-3 align-self-center bg-transparent"><img
                            ...
                            <a href="#" class="dropdown-item d-flex">
                                <span class="avatar  ml-3 align-self-center bg-transparent"><img
                                        ...
                                        alt="img"></span>
                                <div class="d-flex">
                                    <span class="mt-2">الاسبانية</span>
                                </div>
                            </a>
                        </div>
                    </div>
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                        ...
                        <div class="menu-header-content bg-primary text-right">
                            <div class="d-flex">
                                ...
                                <span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a
                                        href="\MarkAllAsRead">تعيين قراءة الكل</a></span>
                            </div>
                            <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">
                            <h6 style="color: yellow" id="notifications_count">
                                <br>
                                لديك ({{ auth()->user()->unreadNotifications->count() }}) من الإشعارات الغير مقروءة
                            </h6>
                            </p>
                        </div>
                            ...
                            <div class="main-notification-list Notification-scroll">
                                @foreach (auth()->user()->unreadNotifications as $notification)
                                    <a class="d-flex p-3 border-bottom"
                                        href="{{ url('invoice_details') }}/{{ $notification->data['id'] }}">
                                        ...
                                        <div class="mr-3">
                                            ...
                                            @php
                                                ...
                                                $hoursDiff = $createdAt->diffInHours($currentDateTime);
                                                
                                                $timeAgo = ($hoursDiff !== 1 ? 's' : '') . ' قبل ' . $hoursDiff . ' من الساعات';
                                            @endphp




                                            <div class="notification-subtext">{{ $timeAgo }}</div>
                                        </div>
                                    </a>
                                @endforeach
                            </div>
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="{{ URL::asset('assets/img/download.png') }}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt=""
                                        src="{{ URL::asset('assets/img/download.png') }}" class=""></div>
                        ...
                        <a class="dropdown-item" href="{{ route('logout', 'web') }}"
                            onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i
                                class="bx bx-log-out" data-feather="power"></i>تسجيل الخروج</a>
                        @if (auth('web')->check())
