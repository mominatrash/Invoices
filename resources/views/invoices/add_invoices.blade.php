...
<script>
    ...
    $(document).ready(function() {
        $('select[name="Section"]').on('change', function() {
            ...
            if (SectionId) {
                // Add the loading option to the select element and select it
                $('select[name="product"]').html('<option value="">جاري التحميل ...</option>').val('');
                $.ajax({
...
<script>
    ...
    document.getElementById("value_vat").addEventListener("input", myFunction);
