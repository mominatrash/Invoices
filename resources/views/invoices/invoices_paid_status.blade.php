            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="example1" class="table key-buttons text-md-nowrap">
                        ...
                        @if(Route::is('invoices_paid'))
                        <tbody>
                            @foreach ($invoices_paid as $i)
                                <tr>
                                    <td>{{ $i->id }}</td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                ...
                                                <a class="dropdown-item" href="/{{ $i->id }}"><i
                            ...
                            @if(Route::is('invoices_unpaid'))
                            <tbody>
                                @foreach ($invoices_unpaid as $i)
                                    <tr>
                                        <td>{{ $i->id }}</td>
                                        <td>
                                            <a href="{{ url('invoice_details') }}/{{ $i->id }}">
                                ...
                                @if(Route::is('invoices_paritally_paid'))
                                <tbody>
                                    @foreach ($invoices_paritally_paid as $i)
                                        <tr>
                                            <td>{{ $i->id }}</td>
                                            <td>
                                                <a href="{{ url('invoice_details') }}/{{ $i->id }}">
